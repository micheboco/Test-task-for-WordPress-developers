...
use function GutenbergTheme\print_global_scaffolding_section;

?>

<section class="section-scaffolding">

	<h2 class="scaffolding-heading" id="<?php esc_html_e( 'globals', 'gutenbergtheme' ); ?>"><?php esc_html_e( 'Globals', 'gutenbergtheme' ); ?></h2>
