...
<section class="section-scaffolding">
	...
	<h2 class="scaffolding-heading" id="<?php esc_html_e( 'typography', 'gutenbergtheme' ); ?>">
		<?php esc_html_e( 'Typography', 'gutenbergtheme' ); ?></h2>
	...
	print_scaffolding_section(
		[
			...
			'usage'       => '<del>Gutenberg_Theme</del>',
			'output'      => '<p>We use <del>Gutenberg_Theme</del> wd_s to build themes.</p>',
		]
	);
