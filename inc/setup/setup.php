...
function setup() {
	 ...
	 * references of wd_s
	 */
	load_theme_textdomain( 'gutenbergtheme', get_template_directory() . '/build/languages' );
	...
	register_nav_menus(
		[
			'primary' => esc_html__( 'Primary Menu', 'gutenbergtheme' ),
			'footer'  => esc_html__( 'Footer Menu', 'gutenbergtheme' ),
			'mobile'  => esc_html__( 'Mobile Menu', 'gutenbergtheme' ),
		]
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'gutenbergtheme_custom_background_args',
			[
